    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/dashboard">
                ...
                <div class="sidebar-brand-text mx-3">SecondMedia<sup>2</sup></div>
            </a>
            ...
            <li class="nav-item {{request()->is('admin/loyalty') ? 'active': ''}}">
                <a class="nav-link" href="/admin/loyalty">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Ruth Grace</span>
